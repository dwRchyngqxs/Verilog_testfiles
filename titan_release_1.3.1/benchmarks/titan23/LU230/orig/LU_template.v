...
module LU_TOP_PEEng (clk,  start, N, offset, done, mem_addr, mem_ba, mem_cas_n, mem_cke, mem_cs_n,
...
REPLACE THE FOLLOWING PARAMETERS WITH THE GENERATED PARAMETERS
...
parameter RAMWIDTH = 4096, RAMNUMBYTES = 512, RAMSIZEWIDTH = 7;*/
