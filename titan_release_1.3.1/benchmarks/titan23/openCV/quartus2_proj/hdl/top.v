...
usb_portmux usb_portmux_inst(
	...
	.OSC1_50(OSC_50_BANK2),
	 ...
	 // User signals
		...
		.command_data(command_data),//fine to rm
	.command_wanted(command_wanted),
		.command_ready(command_ready),//fine to rm
		
	.stats_data(stats_data),
		.stats_ready_to_accept(stats_ready_to_accept),//fine to rm
	.stats_ready_to_return(stats_ready_to_return),
		
		.feature_data(feature_data),//fine to rm
