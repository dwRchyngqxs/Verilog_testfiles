...
// 
// OpenSPARC T1 Processor File: pcx_dp4.v
...
module pcx_dp4(/*AUTOARG*/
   // Outputs
   scan_out, pcx_io_data_px_l, 
   // Inputs
   shiftenable, scan_in, rclk, arbpc4_pcxdp_shift_px, 
   arbpc4_pcxdp_qsel1_pa, arbpc4_pcxdp_qsel0_pa, 
   arbpc4_pcxdp_q0_hold_pa, arbpc4_pcxdp_grant_pa, spc0_pcx_data_pa, 
   ...
   spc7_pcx_data_pa
	      ...
	      // End of automatics
              ...
              output [`PCX_WIDTH-1:0]  pcx_io_data_px_l;       // From mac4 of pcx_dp_macc.v

              /*AUTOINPUT*/
	      // Beginning of automatic inputs (from unused autoinst inputs)
	      input [7:0]     arbpc4_pcxdp_grant_pa;  // To mac0 of pcx_dp_maca_r.v, ...
	      input [7:0]     arbpc4_pcxdp_q0_hold_pa;// To mac0 of pcx_dp_maca_r.v, ...
	      input [7:0]     arbpc4_pcxdp_qsel0_pa;  // To mac0 of pcx_dp_maca_r.v, ...
	      input [7:0]     arbpc4_pcxdp_qsel1_pa;  // To mac0 of pcx_dp_maca_r.v, ...
	      input [7:0]     arbpc4_pcxdp_shift_px;  // To mac0 of pcx_dp_maca_r.v, ...
