...
// 
// OpenSPARC T1 Processor File: pcx_dp1.v
...
module pcx_dp1(/*AUTOARG*/
   ...
   spc7_pcx_data_pa
	      ...
	      // End of automatics
              ...
              output [`PCX_WIDTH-1:0]  pcx_scache1_data_px_l;  // From mac3 of pcx_dp_macc.v

              /*AUTOINPUT*/
	      // Beginning of automatic inputs (from unused autoinst inputs)
	      input [7:0]     arbpc1_pcxdp_grant_pa;  // To mac0 of pcx_dp_maca_r.v, ...
	      input [7:0]     arbpc1_pcxdp_q0_hold_pa;// To mac0 of pcx_dp_maca_r.v, ...
	      input [7:0]     arbpc1_pcxdp_qsel0_pa;  // To mac0 of pcx_dp_maca_r.v, ...
	      input [7:0]     arbpc1_pcxdp_qsel1_pa;  // To mac0 of pcx_dp_maca_r.v, ...
	      input [7:0]     arbpc1_pcxdp_shift_px;  // To mac0 of pcx_dp_maca_r.v, ...
