...
// 
// OpenSPARC T1 Processor File: cpx_dp2.v
...
output  [`CPX_WIDTH-1:0]  cpx_spc2_data_cx_l;
   
   

              /*AUTOINPUT*/
	      // Beginning of automatic inputs (from unused autoinst inputs)
	      input [5:0]     arbcp2_cpxdp_grant_ca;  // To mac0 of cpx_dp_maca_r.v, ...
	      input [5:0]     arbcp2_cpxdp_q0_hold_ca;// To mac0 of cpx_dp_maca_r.v, ...
	      input [5:0]     arbcp2_cpxdp_qsel0_ca;  // To mac0 of cpx_dp_maca_r.v, ...
	      input [5:0]     arbcp2_cpxdp_qsel1_ca;  // To mac0 of cpx_dp_maca_r.v, ...
	      input [5:0]     arbcp2_cpxdp_shift_cx;  // To mac0 of cpx_dp_maca_r.v, ...
...
//			  .data_out_cx_l	(cpx_col@_data_cx_l[149:0]),
   ...
   cpx_dp_macc_r mac1(/*AUTOINST*/
		      ...
		      .data_ncrit_cx_l	(cpx_col0_data_cx_l[149:0]), // Templated
		      .rclk		(rclk),
   ...
   cpx_dp_macb_l AUTO_TEMPLATE(
			  ...
			  .arb_cpxdp_qsel1_ca(arbcp2_cpxdp_qsel1_ca[@"(+ @ 1)"]),
			  .arb_cpxdp_qsel0_ca(arbcp2_cpxdp_qsel0_ca[@"(+ @ 1)"]),
			  .arb_cpxdp_grant_ca(arbcp2_cpxdp_grant_ca[@"(+ @ 1)"]),
			  .arb_cpxdp_shift_cx(arbcp2_cpxdp_shift_cx[@"(+ @ 1)"]),
			  .arb_cpxdp_q0_hold_ca(arbcp2_cpxdp_q0_hold_ca[@"(+ @ 1)"]),
   ...
   cpx_dp_macb_l mac3(/*AUTOINST*/
		      ...
		      // Inputs
		      .arb_cpxdp_qsel1_ca(arbcp2_cpxdp_qsel1_ca[4]), // Templated
		      .arb_cpxdp_qsel0_ca(arbcp2_cpxdp_qsel0_ca[4]), // Templated
		      .arb_cpxdp_grant_ca(arbcp2_cpxdp_grant_ca[4]), // Templated
		      .arb_cpxdp_shift_cx(arbcp2_cpxdp_shift_cx[4]), // Templated
		      .arb_cpxdp_q0_hold_ca(arbcp2_cpxdp_q0_hold_ca[4]), // Templated
   ...
   cpx_dp_macb_l AUTO_TEMPLATE(
			  ...
			  .arb_cpxdp_qsel1_ca(arbcp2_cpxdp_qsel1_ca[@"(- @ 2)"]),
			  .arb_cpxdp_qsel0_ca(arbcp2_cpxdp_qsel0_ca[@"(- @ 2)"]),
			  .arb_cpxdp_grant_ca(arbcp2_cpxdp_grant_ca[@"(- @ 2)"]),
			  .arb_cpxdp_shift_cx(arbcp2_cpxdp_shift_cx[@"(- @ 2)"]),
			  .arb_cpxdp_q0_hold_ca(arbcp2_cpxdp_q0_hold_ca[@"(- @ 2)"]),
   ...
   cpx_dp_macb_l mac4(/*AUTOINST*/
		      ...
		      // Inputs
		      .arb_cpxdp_qsel1_ca(arbcp2_cpxdp_qsel1_ca[2]), // Templated
		      .arb_cpxdp_qsel0_ca(arbcp2_cpxdp_qsel0_ca[2]), // Templated
		      .arb_cpxdp_grant_ca(arbcp2_cpxdp_grant_ca[2]), // Templated
		      .arb_cpxdp_shift_cx(arbcp2_cpxdp_shift_cx[2]), // Templated
		      .arb_cpxdp_q0_hold_ca(arbcp2_cpxdp_q0_hold_ca[2]), // Templated
   ...
   cpx_dp_macb_l AUTO_TEMPLATE(
			  ...
			  .arb_cpxdp_qsel1_ca(arbcp2_cpxdp_qsel1_ca[@"(- @ 3)"]),
			  .arb_cpxdp_qsel0_ca(arbcp2_cpxdp_qsel0_ca[@"(- @ 3)"]),
			  .arb_cpxdp_grant_ca(arbcp2_cpxdp_grant_ca[@"(- @ 3)"]),
			  .arb_cpxdp_shift_cx(arbcp2_cpxdp_shift_cx[@"(- @ 3)"]),
			  .arb_cpxdp_q0_hold_ca(arbcp2_cpxdp_q0_hold_ca[@"(- @ 3)"]),
       			  .data_prev_cx_l(cpx_col@"(+ @ 1)"_data_cx_l[149:0]),
           			  .clk		(clk),			 
		    //.tmb_l		(tmb_l),
		    .scan_in		(scan_in[@]),
   ...
   cpx_dp_macb_l mac6(/*AUTOINST*/
		      ...
		      // Inputs
		      .arb_cpxdp_qsel1_ca(arbcp2_cpxdp_qsel1_ca[3]), // Templated
		      .arb_cpxdp_qsel0_ca(arbcp2_cpxdp_qsel0_ca[3]), // Templated
		      .arb_cpxdp_grant_ca(arbcp2_cpxdp_grant_ca[3]), // Templated
		      .arb_cpxdp_shift_cx(arbcp2_cpxdp_shift_cx[3]), // Templated
		      .arb_cpxdp_q0_hold_ca(arbcp2_cpxdp_q0_hold_ca[3]), // Templated
   ...
   cpx_dp_maca_l mac7(/*AUTOINST*/
		      ...
		      // Inputs
		      .arb_cpxdp_qsel1_ca(arbcp2_cpxdp_qsel1_ca[5]), // Templated
		      .arb_cpxdp_qsel0_ca(arbcp2_cpxdp_qsel0_ca[5]), // Templated
		      .arb_cpxdp_grant_ca(arbcp2_cpxdp_grant_ca[5]), // Templated
		      .arb_cpxdp_shift_cx(arbcp2_cpxdp_shift_cx[5]), // Templated
		      .arb_cpxdp_q0_hold_ca(arbcp2_cpxdp_q0_hold_ca[5]), // Templated
